        ...
        <div className="w-full flex justify-center items-center">
          ...
          <div className=" w-full px-4 lg:w-1/2 xl:w-1/2 sm:w-1/2 ">
              <div className=" border-2 rounded-md shadow-sm p-16 mb-5">
                  <h3 className="text-center text-2xl mb-5 font-bold text-blue-500 font-kaushan">Tokoku</h3>
              ...
              <div className="border-2 rounded-md shadow-sm p-10  ">
                  <h2 className="text-center text-xl">Belum punya akun? <Link to='/register' className="text-blue-500 font-bold">Daftar</Link></h2>
              </div>
          </div>
        </div>
      </div>
